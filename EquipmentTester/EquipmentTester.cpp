...
void EquipmentTester::bindTree(QTreeWidgetItem* item,int count)
{
	...
	if (item->text(count) == "XCE18T10K1P1")
	{
		ui.stackedWidget->setCurrentIndex(0);
	}
	else if(item->text(count)=="XCE24T19K1P1(W)")
	{
		ui.stackedWidget->setCurrentIndex(1);
	}
	else if(item->text(count)=="XCE24T26K1P1")
	{
		ui.stackedWidget->setCurrentIndex(2);
	}
	else if(item->text(count)=="XCE12T3K1P1")
	{
		ui.stackedWidget->setCurrentIndex(3);
	}
	else if(item->text(count)=="XCE27T30K1P1")
	{
		ui.stackedWidget->setCurrentIndex(4);
	}
